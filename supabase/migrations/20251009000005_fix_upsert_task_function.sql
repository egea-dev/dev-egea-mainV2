-- Corregir la función upsert_task para que coincida con los parámetros esperados por el frontend
-- Esta migración actualiza la función para que tenga los parámetros correctos
