            ...
            <CardContent className="p-3">
                ...
                >
                    ...
                    <Badge
                        variant="outline"
                        className={cn(
                            "text-[9px] px-1.5 py-0 border-border/60 bg-muted/50 uppercase tracking-wider h-5 flex items-center",
                    ...
                    <div className="flex flex-wrap gap-1 items-center min-h-[1.25rem]">
                        ...
                        {(task.assigned_profiles as any[])?.length > 0 ? (
                            (task.assigned_profiles as any[]).map((user: any) => (
                                <div
                                    key={user.id}
                                    className="bg-muted text-foreground text-[9px] px-1.5 py-0.5 rounded flex items-center gap-1 border border-border/40"
