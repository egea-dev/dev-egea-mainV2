                                ...
                                <CardHeader className="py-3 px-4">
                                    <div className="flex items-center justify-between">
                                        <CardTitle className="text-sm font-medium flex items-center gap-2">
                                            ...
                                            <span className={cn(isCurrentDay && "text-blue-400")}>
                                                {format(day, "EEEE d 'de' MMMM", { locale: es })}
                                            </span>
                                            {isCurrentDay && (
                                                <Badge className="bg-blue-500/20 text-blue-400 text-xs">HOY</Badge>
                                            )}
                                        </CardTitle>
                        ...
                        >
                            <div className="flex items-center justify-between mb-1">
                                <span className={cn(
                                    ...
                                    !isTodayDay && "text-gray-300"
                                )}>
                                    {format(day, 'd')}
                                </span>
                                {dayOrders.length > 0 && (
                                    <Badge variant="secondary" className="text-[10px] h-4 px-1 bg-blue-500/20 text-blue-400">
                                        {dayOrders.length}
                                    </Badge>
                                )}
                            </div>
