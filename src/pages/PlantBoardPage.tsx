    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans overflow-hidden flex flex-col">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-3xl font-black tracking-wider text-white uppercase flex items-center gap-3">
                            <span className="text-[#D4AF37]">PLANIFICACION</span> PLANTA
                        </h1>
            ...
            <div className="px-8 py-4 bg-[#111] grid grid-cols-12 gap-4 text-gray-500 font-bold text-sm uppercase tracking-wider border-b border-white/5">
                ...
                <div className="col-span-3">MATERIAL / COLOR</div>
            ...
            <div className="flex-1 px-8 py-4 space-y-3 overflow-y-auto custom-scrollbar">
                {orders.length === 0 ? (
                    ...
                    orders.map((order) => (
                        <div key={order.id} className="grid grid-cols-12 gap-4 items-center bg-[#1A1D1F] p-4 rounded-lg border-l-4 border-l-[#D4AF37] shadow-lg animate-in fade-in duration-500">
                            ...
                            <div className="col-span-3 pr-8">
                                ...
                                <Progress value={order.stage_progress} className="h-2 bg-black/50" indicatorClassName="bg-[#D4AF37]" />
                                <div className="text-[10px] text-gray-600 mt-2 uppercase tracking-wide text-right">Fase: {order.status}</div>
                            </div>

                            {/* COL 5: ESTADO (DIAS) */}
                            <div className="col-span-1 flex justify-end">
                                <div className="text-center">
                                    <span className="text-3xl font-bold text-white tracking-tighter">{order.days_elapsed}</span>
